...
//total pages
        $html = " 共 " . $this->pagecount . " 页";

//back links
        if ($this->pagenumber > 1) {
            $html .= " <a class=\"{$this->cssclass_link}\" href=\"{$link}1\">首页</a> "; //end with "page=1"
            $html .= " <a class=\"{$this->cssclass_link}\" href=\"" . $link . ($this->pagenumber - 1) . "\">上一页</a> ";
        }
...
//next links
        if ($this->pagenumber < $this->pagecount) {
            $html .= " <a class=\"{$this->cssclass_link}\" href=\"" . $link . ($this->pagenumber + 1) . "\">下一页</a> ";
            $html .= " <a class=\"{$this->cssclass_link}\" href=\"{$link}{$this->pagecount}\">尾页</a> ";
        }
