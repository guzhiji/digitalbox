...
function cancelMove(){
	window.location="admin_content.php?module=content&function=cancelmove&channel={$channelid}";
}
function moveHere(){
	...
	if(cid>0){
		...
		f.method="post";
		f.action="admin_content.php?module=content&type={$type}&function=move&class="+cid;
		f.submit();
