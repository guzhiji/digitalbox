...
//<![CDATA[
function cancelMove(){
	window.location="admin_content.php?module=content&class={$classid}&function=cancelmove";
}
function moveHere(){
	var f=document.admin_content;
	f.method="post";
	f.action="admin_content.php?module=content&class={$classid}&type={$type}&function=move";
	f.submit();
}
function goBack(){
