...
<table>
    ...
    <tr><td>
            <form action="admin_script.php?function=add" method="post">
                脚本名称： <input type="text" name="name" class="textinput2" /> <input type="button" value="添加" class="button1" onclick="confirmAdding(this.form)" />
            </form>
        </td>
    </tr>
    ...
    <tr><td align="center">
            <form action="admin_script.php?function=set" method="post">
                ...
                <div>
                    ...
                    <input type="button" value="返回" class="button1" onclick="window.location='admin_setting.php'" />
                </div>
            </form>
        </td>
    </tr>
