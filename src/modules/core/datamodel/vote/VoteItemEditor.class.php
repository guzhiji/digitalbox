...
class VoteItemEditor extends DataItem {
    ...
    public function SetCaption($caption) {
        $this->SetValue("Caption", $caption, IBC1_DATATYPE_PURETEXT);
    }
    ...
    public function SetCatalogService($servicename) {
        ...
        $sm = new DataModelManager($this->GetDBConnProvider(), $this->GetError());
        if ($sm->Exists($servicename, "clg"))
            $this->SetValue("CatalogService", $servicename, IBC1_DATATYPE_PURETEXT);
    }
