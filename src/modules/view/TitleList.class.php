...
class TitleList extends ListView {
    ...
    function __construct($checkboxname="", $maxlen=30) {
        parent::__construct("titlelist_item" . (($checkboxname != "") ? "_checkbox" : ""), "titlelist_item_empty");
...
//        $this->SetFooter("titlelist_footer", array());
    ...
    function AddItem() {
        ...
        if ($this->_icon_visible) {
            $ico = "<img border=\"0\" width=\"15\" height=\"15\" src=\"" . GetResPath("icon_" . $this->_content_type_en . ".gif", "images", GetSettingValue("style_id")) . "\">";
        }
        ...
        switch ($this->_extra_mode) {
            case 1:
                $extra = "(时间：" . $this->_content_time . ")";
                break;
            case 2:
                $extra = "(点击：" . $this->_content_visitor . ")";
                break;
            case 3:
